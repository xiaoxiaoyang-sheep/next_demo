...
export default function AppPage({
	...
	if(isPending) {
		...
		children = <div className=" border max-w-48 m-auto mt-10 flex flex-col items-center p-4 rounded-md">
			<p className=" text-lg">App Not Exist</p>
			<p className=" text-sm">Chose another one</p>
			<div className=" flex flex-col items-center mt-5">
				{apps?.map((app) => <Button key={app.id} asChild variant="link" className=" w-full">
